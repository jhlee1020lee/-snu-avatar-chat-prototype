...
10441 |             case "목발":
10442 |                 prefix = "처음에는 목발이 눈에 들어올 수 있어요. 그래도 제 하루는 그 장면 하나로만 설명되지는 않습니다.";
10444 |             case "책상":
10445 |                 prefix = "책상은 제 일과 공부가 가장 또렷하게 드러나는 자리예요. 그 안에도 이동과 도움을 맞춰 가는 시간이 함께 놓여 있습니다.";
10447 |             case "표정":
10448 |                 prefix = "표정만으로 하루를 다 알 수는 없어요. 같은 분위기 안에도 생활의 여러 장면이 같이 놓여 있습니다.";
