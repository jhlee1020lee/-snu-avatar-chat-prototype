...
function makeUnverifiedPreferenceReply() {
  return [
    "좋아하는 것으로 분명하게 남는 장면은 게임과 코인노래방입니다. 이동이나 도움 이야기만 보면 사람이 불편함 쪽으로만 좁아질 수 있지만, 쉬고 노는 시간까지 함께 보면 하루가 더 입체적으로 보입니다.",
    "",
...
const LOCAL_SUGGESTION_TOPICS = [
  ...
  {
    pattern: /(책상|노트북|컴퓨터|박사|직장|업무|공부|일과 공부)/,
    suggestions: [
  ...
  {
    pattern: /(직장|동료|기여|결과물|프로젝트|기획서|회사|필요한 도움)/,
    suggestions: [
...
const LOCAL_BRIDGE_REPLIES = [
  ...
  },
  {
    ...
    reply: [
      "이 전시에서 중요한 물건은 목발, 자취방, 책상과 노트북입니다. 목발만 보면 이동의 조건이 먼저 보이지만, 책상과 노트북까지 보면 일과 공부를 이어가는 시간이 같이 보입니다.",
      "",
  ...
  },
  {
    ...
    reply: [
      "전시에서 중요한 방향은 분명합니다. 처음에는 목발이 보일 수 있지만, 시선이 자취방과 책상, 일과 공부, 취미까지 이어져야 합니다.",
      "",
